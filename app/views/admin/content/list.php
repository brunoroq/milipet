...
$sectionName = $labels[$section] ?? ucfirst($section);
?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        <h1 class="mb-2">
          ...
          Contenido: <?= htmlspecialchars($sectionName) ?>
        </h1>
        <p class="text-muted mb-0">
          Edita los bloques de contenido de esta sección de la página.
        </p>
      </div>
              ...
              <?php if (empty($blocks)): ?>
                <tr>
                  <td colspan="5" class="text-center text-muted py-4">
                    ...
                    No hay bloques de contenido en esta sección.
                  </td>
                </tr>
              <?php else: ?>
